// Static comments
// original source: https://github.com/eduardoboucas/popcorn/blob/gh-pages/js/main.js
(function ($) {
  ...
  $('.js-form').submit(function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        showModal('Comment submitted', 'Thank you. Your comment is <a href="https://github.com/nbn-tbc/nbn-tbc.github.io/pulls">pending</a>. It will appear here when approved.');
